...
const sliderBoxWidht = document.querySelector(".fof__slider").clientWidth;
...
setTimeout(() => {
  const sliderTrack = document.querySelector(".slick-track").clientWidth;
  const slickActive = document.querySelectorAll(".slick-active");

  for (let i = 0; i < slickActive.length; i++) {
    slickActive[i].addEventListener("mouseover", (e) => {
      //   slickActive[i].querySelector(".item__content").style.left =
    });
  }
}, 2000);
